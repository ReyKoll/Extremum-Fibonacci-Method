    ...
    class ExtremumPresenter
    {
        ...
        public void Calculate(MainWindow window)
        {
            ...
            if (window.rbtSin.Checked)
            {
                ...
                _extremumView.TxtX = extremum.Find(FMath.Function.Sin).ToString("0.0000");
                _extremumView.TxtFX = FX.ToString("0.0000");
            }
            ...
            if (window.rbtCos.Checked)
            {
                ...
                _extremumView.TxtX = extremum.Find(FMath.Function.Cos).ToString("0.0000");
                _extremumView.TxtFX = FX.ToString("0.0000");
            }
            ...
            if (window.rbtParabola.Checked)
            {
                ...
                _extremumView.TxtX = extremum.Find(FMath.Function.Parabola).ToString("0.0000");
                _extremumView.TxtFX = FX.ToString("0.0000");
            }
            ...
            if (window.rbtLine.Checked)
            {
                ...
                _extremumView.TxtX = extremum.Find(FMath.Function.Line).ToString("0.0000");
                _extremumView.TxtFX = FX.ToString("0.0000");
            }
        }
        ...
        {
            if (window.rbtSin.Checked == false
        ...
        public void AnyTextBoxEmpty()
        {
            _extremumView.TxtA = _extremumView.TxtB 
                = _extremumView.TxtH = _extremumView.TxtEpsilon 
                    = _extremumView.TxtX = _extremumView.TxtFX 
                        = _extremumView.TxtMaxY = _extremumView.TxtMinY = string.Empty;
        }
    }
}